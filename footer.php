...
<section class="overlay">
        <div class="aboutus">
        <h2><img style="object-fit:unset" width="90" height="90" src="/images/logoft.png" data-src="/images/logoft.png" alt="VNBSports" class=""> DC SPORT</h2>
          <p>Chúng tôi luôn ở đây và lắng nghe bạn!</p>
          <p>Địa chỉ: 162 Nguyễn Văn Cừ, An Khánh, Ninh Kiều, Cần Thơ</p>
          <p>Điện thoại: 1900 1220</p>
          <p>Gmail: dolcevivafurniture@gmail.com</p>
        </div>
        ...
        <div class="enter_pay">
          <div class="enter">
            ...
            <p>Đăng kí ngay! Để nhận thật nhiều ưu đãi</p>
